...
class MyApp(Tk) :
    ...
    def __init__(self, title) :
        ...
        self.forcedSimplePendulum = PendulumWindow(self, app_width, app_height,presentationText1)
        self.doublePendulum = PendulumWindow(self, app_width, app_height,presentationText1)
        self.forcedDoublePendulum = PendulumWindow(self, app_width, app_height,presentationText1) 
