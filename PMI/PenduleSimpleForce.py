####################################################
##### Interface graphique pendule simple forcé #####
####################################################
...
graphFrame = Frame(rootForcedSimple, bg = '#d3d3d3')
variablesFrame = Frame(rootForcedSimple, bg = '#d3d3d3')
...
def loadfGraph() :
    ...
    theta, thetaPoint, t = sv.solveForcedSimplePendulum(variablesList)
    
    fig = Figure(figsize = (13.3, 9.8), dpi = 60)        
    plot1 = fig.add_subplot(221)                # theta as a function of t
    ...
    plot2 = fig.add_subplot(222)                # energy as a function of t
    Ec = nrj.EcSimple(thetaPoint, float(variablesList[1]), m)
    Ep = nrj.EpForcedSimple(theta, t, float(variablesList[1]), m, float(variablesList[3]), float(variablesList[7]))
    ...
    animateSimpleForcedPendulum(variablesList)
...
wEntry = Entry(subFrame1, bg ='#cbb9aa')
wLabel = Label(subFrame1, text="Origin's oscillation\nfrequency", bg ='#d3d3d3', font=("Helvetica", 12))
...
wEntry.grid(row = 7, column = 0, sticky = 'nsew',padx = 10, pady = 10)
wEntry.grid_propagate(False)
wLabel.grid(row = 6, column = 0, sticky = 'nsew',padx = 10, pady = 10)
wLabel.grid_propagate(False)
clearButton.grid(row = 8, column = 0, sticky = 'nsew',padx = 10, pady = 10)
clearButton.grid_propagate(False)
backButton.grid(row = 9, column = 0, sticky = 'nsew',padx = 10, pady = 10)
...
subFrame1.rowconfigure(index = 8, pad = 5, weight=7)
subFrame1.rowconfigure(index = 9, pad = 5, weight=7)
...
AEntry = Entry(subFrame2, bg ='#cbb9aa')
ALabel = Label(subFrame2, text="Origin's amplitude\nof oscillation", bg ='#d3d3d3', font=("Helvetica",12))
loadButton = Button(subFrame2, text = "load", command = loadfGraph , bg ='#cbb9aa', font="Helvetica")
...
AEntry.grid(row = 7, column = 0, sticky = 'nsew',padx = 10, pady = 10)
ALabel.grid(row = 6, column = 0, sticky = 'nsew',padx = 10, pady = 10)
loadButton.grid(row = 8, column = 0, sticky = 'nsew',padx = 10, pady = 10)
...
subFrame2.rowconfigure(index = 8, pad = 5, weight=4)
...
rootForcedSimple.rowconfigure(index = 0, pad = 20, weight=1)
rootForcedSimple.columnconfigure(index = 0, pad = 20, weight=2)
rootForcedSimple.columnconfigure(index = 1, pad = 20, weight=1) 