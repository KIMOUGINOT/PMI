####################################################
##### Interface graphique pendule double forcé #####
####################################################

import solveurDouble as sd
import animationPenduleDouble as anim
from AnimationPenduleForce import *
from menu import *
...
graphFrame = Frame(rootForcedDouble, bg = '#d3d3d3')
variablesFrame = Frame(rootForcedDouble, bg = '#d3d3d3')
...
def loadfdGraph() :
    ...
    phi1, phi2, x1, y1, x2, y2, xO, yO, t = sd.solveForcedDoublePendulum(variablesList)
    ...
    # anim.animateForcedDoublePendulum(variablesList)
    ani()
...
wEntry.grid(row = 11, column = 0, sticky = 'nsew',padx = 3, pady = 3)
wEntry.grid_propagate(False)
wLabel.grid(row = 10, column = 0, sticky = 'nsew',padx = 3, pady = 3)
wLabel.grid_propagate(False)
clearButton.grid(row = 12, column = 0, sticky = 'nsew',padx = 10, pady = 10)
clearButton.grid_propagate(False)
backButton.grid(row = 13, column = 0, sticky = 'nsew',padx = 10, pady = 10)
...
subFrame1.rowconfigure(index = 10, pad = 5, weight=5)
subFrame1.rowconfigure(index = 11, pad = 5, weight=5)
subFrame1.rowconfigure(index = 12, pad = 5, weight=7)
subFrame1.rowconfigure(index = 13, pad = 5, weight=7)
...
AEntry.grid(row = 11, column = 0, sticky = 'nsew',padx = 3, pady = 3)
ALabel.grid(row = 10, column = 0, sticky = 'nsew',padx = 3, pady = 3)
loadButton.grid(row = 12, column = 0, sticky = 'nsew',padx = 10, pady = 10)
...
subFrame2.rowconfigure(index = 10, pad = 5, weight=1)
subFrame2.rowconfigure(index = 11, pad = 5, weight=1)
subFrame2.rowconfigure(index = 12, pad = 5, weight=4)
...
rootForcedDouble.rowconfigure(index = 0, pad = 20, weight=1)
rootForcedDouble.columnconfigure(index = 0, pad = 20, weight=2)
rootForcedDouble.columnconfigure(index = 1, pad = 20, weight=1) 